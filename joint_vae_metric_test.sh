...
python joint_script_metric_test.py --repr_type word2vec50d
python joint_script_metric_test.py --repr_type word2vec300d
python joint_script_metric_test.py --repr_type one-hot
