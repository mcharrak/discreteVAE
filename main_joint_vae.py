...
if __name__ == "__main__":
    ...
    parser.add_argument('--z_dims_str', default = "1200,5,5,5,5,5,5,5,5", type=str, help='dimension of each latent variable in the code except the first positions which will be added later on and always is equal to number of used_tuples + 10perc.')
...
#        args.z_dim_disc_list = [int(1.1*args.n_used_tuples)] + [int(entry) for entry in args.z_dims_str.split(",")]
